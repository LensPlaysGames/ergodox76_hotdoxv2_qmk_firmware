 ...
 */
  ...
  [HOME] = LAYOUT(
        ...
        TG(SYMS),    KC_Y, KC_U,    KC_I,    KC_O,   KC_P,              KC_BSLS,
        ...
        KC_NO,
        KC_EQL,  MT(MOD_LCTL,KC_TAB), MT(MOD_LCTL,KC_ENT)
    ),
 ...
 */
    [NUMPAD] = LAYOUT(
       ...
       KC_NUM,   KC_P7,   KC_P8,   KC_P9,   KC_PAST, KC_PEQL, KC_TRNS,
                 KC_TRNS, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_PENT,
       TO(HOME), KC_P1,   KC_P2,   KC_P3,   KC_PSLS, KC_UP,   KC_TRNS,
